...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
		KC_GRV,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_TRNS,   KC_TRNS,    KC_TRN     KC_TRNS,   KC_MUTE,   KC_VOLD,   KC_VOLU,
		KC_CAPS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_LEFT,    KC_DOWN,   KC_UP,     KC_RIGHT,  KC_SCLN,   KC_BSLS,
