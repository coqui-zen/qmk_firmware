...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
		...
		KC_LCTL,  KC_LALT,                    MO(2),   MO(1),	      KC_SPC, KC_RALT,                          KC_LGUI, KC_RGUI
    ),
    ...
    LAYOUT(
		...
		KC_TRNS,  KC_MUTE,   KC_VOLD,   KC_VOLU,   KC_TRNS,    KC_TRNS,          KC_TRNS,   KC_P4,    KC_P5,   KC_P6,   KC_LBRC,   KC_RBRC,
		KC_TRNS,  KC_MAIL,   KC_WBAK,   KC_WFWD,   KC_TRNS,    KC_TRNS,          KC_TRNS,   KC_P1,    KC_P2,   KC_P3,   KC_TRNS,   KC_TRNS,  KC_TRNS,
		KC_TRNS,  KC_TRNS,                         KC_TRNS,    KC_TRNS,	         KC_PENT,   KC_PDOT,                               KC_TRNS,  KC_TRNS
    ),

    LAYOUT(
		KC_TRNS,  LCA_T(KC_F1),         LCA_T(KC_F2),        LCA_T(KC_F3),        LCA_T(KC_F4),         LCA_T(KC_F6),     KC_GRV,    KC_EXLM,    KC_HASH,   KC_DLR,   KC_PLUS,    KC_F11,   KC_F12,
		KC_TRNS,  KC_TRNS,              KC_TRNS,             KC_TRNS,             KC_TRNS,              KC_TRNS,          KC_TRNS,   KC_PERC,    KC_ASTR,   KC_AMPR,  KC_EQL,          KC_TRNS,
		KC_TRNS,  KC_TRNS,              KC_TRNS,             KC_TRNS,             KC_TRNS,              KC_TRNS,          KC_TRNS,   KC_UNDS,    KC_MINS,   KC_AT,    KC_TILDE,   KC_BSLS,  KC_TRNS,
